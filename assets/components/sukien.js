...
eventsList.innerHTML = pkg[urlParams.get('page') - 1].map(function(item,index){
      ...
      <div class="item-image">
         <a href="./chitietsukien.html?page=${index + 1}" class = "w-100">
            <img class="w-100" src="${item.imgUrl}">
         </a>
      </div>
      <div class="ms-5 item-content">
         <a href="./chitietsukien.html?page=${index + 1}" title="LUG.vn hân hạnh tài trợ giải quần vợt ra mắt diễn đàn tennis TP. Thủ Đức">
